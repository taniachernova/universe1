...
const PageProductDetails = ({ product }) => {
  ...
  //       description: `Mesleğinin hakkını veren seksi eskortların İstanbul’da neler sunduğunu bilmeyenler olabilir. Esmer escort kadınlara olan ilgi her geçen gün artmaktadır ve`,
  //       breadcrumb: {
  //         "@id": `https://universeescort.com/escort/${name
  //           .toLowerCase()
  //           .split(" ")
  ...
  //       name: `${name} - ${title}  - Universe Escort`,
  //       description: `İstanbul'un ateşli eskortu ${name}'nın ayrıntılı profiline göz atın. UniverseEscort.com'daki özel eskort profili, 
  ...
  //         url: logo,
  //         contentUrl: logo,
  //         caption: "İstanbul escort - Universe Escort",
  //       },
  //       image: {
  //         "@id": logo,
  //       },
  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta
          name="description"
          content={`İstanbul'un ateşli eskortu ${name}'nın ayrıntılı profiline göz atın. UniverseEscort.com'daki özel eskort profili, 
          seksi fotoğrafları, videoları ve ateşli hizmetleriyle sizi bekliyor.`}
        />
        ...
        <meta
          property="og:title"
          content={name + " - Istanbul Escort | universeescort.com"}
        />
        <meta
          name="og:description"
          content={`İstanbul'un ateşli eskortu ${name}'nın ayrıntılı profiline göz atın. UniverseEscort.com'daki özel eskort profili, 
